...
The following code generates `r simulations` simulations of `r samples` variables and stores the means of each simulation in `meanexp`. This set of simulations are then plotted with the `data.frame meanDF` variable.
